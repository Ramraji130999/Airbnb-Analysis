...
def datafr():
    df= pd.read_csv("C:/Users/nandh/Desktop/Airbnb/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open("C:/Users/nandh/Desktop/Airbnb/airbnb_image.webp")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/nandh/Desktop/Airbnb/Airbnb.csv")
            return df_a
